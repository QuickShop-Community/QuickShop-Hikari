...
public class VarNode implements Node {
  ...
  public VarNode(final String variable) {
  ...
  public Component parse(final SignParserProvider parserProvider, final Shop shop, final ParserContext context) {
    ...
    if(parserProvider.variables().containsKey(variable)) {

      return parserProvider.variables().get(variable).apply(shop, context);
    }
    return Component.text(variable);
  }
}

 ...
 * @since 6.3.0.0
 */
public class ShopCreateRequest implements ShopRequest {

  protected final ShopUpdateOptions options;
  protected final CommandSender actor;
  protected final ModernShop<?, ?, ?, ?> shop;

  public ShopCreateRequest(final ShopUpdateOptions options,
  ...
  public ShopCreateRequest(final Builder builder) {

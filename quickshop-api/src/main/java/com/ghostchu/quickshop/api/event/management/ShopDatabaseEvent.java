...
public class ShopDatabaseEvent extends ShopEvent {
  ...
  public ShopDatabaseEvent(final @NotNull Shop shop) {

    super(shop);
  }

  public ShopDatabaseEvent(final Phase phase, final @NotNull Shop shop) {
   ...
   */
  @Override
  public ShopDatabaseEvent clone(final Phase newPhase) {

    return new ShopDatabaseEvent(newPhase, this.shop);
  }
}
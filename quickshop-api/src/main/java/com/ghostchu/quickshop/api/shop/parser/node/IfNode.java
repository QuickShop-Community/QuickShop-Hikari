...
public class IfNode implements Node {
  ...
  public IfNode(final NodeCondition condition, final Node trueNode, final Node falseNode) {
  ...
  public Component parse(final SignParserProvider parserProvider, final Shop shop, final ParserContext context) {
    ...
    return (condition.test(parserProvider, shop, context)? trueNode : falseNode).parse(parserProvider, shop, context);
  }
}
...
public class ShopProtectionCheckEvent extends AbstractQSEvent {
  ...
  /**
   * Will call when checking protection by other plugin, This event was used to compatible with
   * QuickShop protection checking Which will fire a FAKE BlockBreakEvent
   *

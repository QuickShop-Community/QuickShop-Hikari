 ...
 * @since 6.3.0.0
 */
public class NexoCheck implements ItemCheck {
  ...
  public boolean matches(final @Nullable ItemStack stack, final @Nullable ItemStack compare) {
    ...
    final String originalID = NexoItems.idFromItem(stack);
    final String compareID = NexoItems.idFromItem(compare);
    ...
    return originalID.equals(compareID);
  }
}
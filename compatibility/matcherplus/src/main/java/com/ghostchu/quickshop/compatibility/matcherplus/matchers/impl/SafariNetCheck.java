 ...
 * @since 6.3.0.0
 */
public class SafariNetCheck implements ItemCheck {
    ...
    public boolean matches(final @Nullable ItemStack stack, final @Nullable ItemStack compare) {
        ...
        if(stack == null && compare != null || compare == null && stack != null) {
            return false;
        }
        ...
        return Main.isSimilar(stack, compare, true);
    }
}
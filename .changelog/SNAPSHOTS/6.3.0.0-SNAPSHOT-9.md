...
- Added /qs setuppermission to provide an easier permission setup for LuckPerms users.
  - /qs setuppermission player [group] will add the player permissions to the group(defaults to default)
  - /qs setuppermission moderator [group] will add the moderator permissions to the group(defaults to default)
  - /qs setuppermission check will check the default group for moderator permissions and remove if found.

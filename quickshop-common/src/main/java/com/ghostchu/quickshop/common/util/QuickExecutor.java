...
public class QuickExecutor {
    private static final ExecutorService HIKARICP_EXECUTOR = new ThreadPoolExecutor(2, 16, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
    private static final ExecutorService SHOP_HISTORY_QUERY_EXECUTOR = new ThreadPoolExecutor(1, 2, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
    private static final ExecutorService SHOP_SAVE_EXECUTOR = new ThreadPoolExecutor(1, 2, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue<>());

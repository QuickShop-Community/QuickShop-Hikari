 ...
 */
@SuppressWarnings({"all"}) // we don't care this class that copy from bstats few years ago. just works.
public class Metrics {
     ...
     * @param pluginId The id of the plugin. It can be found at <a

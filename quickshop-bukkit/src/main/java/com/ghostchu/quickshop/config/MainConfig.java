  ...
  public MainConfig(final QuickShop plugin) {
    ...
    super("config.yml", "config.yml", Collections.emptyList(),
          ...
          UpdaterSettings.builder().setAutoSave(true)
                  ...
                  .addIgnoredRoute("1049", "limits.ranks", '.')
                  .addIgnoredRoute("1050", "limits.ranks", '.')
                  .addIgnoredRoute("1051", "limits.ranks", '.')
                  .addIgnoredRoute("1052", "limits.ranks", '.')
                  .addIgnoredRoute("1053", "limits.ranks", '.')
                  ...
                  .addIgnoredRoute("1049", "shop-tax.progressive.brackets", '.')
                  .addIgnoredRoute("1050", "shop-tax.progressive.brackets", '.')
                  .addIgnoredRoute("1051", "shop-tax.progressive.brackets", '.')
                  .addIgnoredRoute("1052", "shop-tax.progressive.brackets", '.')
                  .addIgnoredRoute("1053", "shop-tax.progressive.brackets", '.')
                  .build());

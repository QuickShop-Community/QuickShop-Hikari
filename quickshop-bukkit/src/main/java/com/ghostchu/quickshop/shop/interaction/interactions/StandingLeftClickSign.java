 ...
 * @since 6.2.0.11
 */
public class StandingLeftClickSign implements InteractionType {
  ...
  public String identifier() {
    ...
    return "STANDING_LEFT_CLICK_SIGN";
  }
  ...
  public boolean applies(final @NotNull PlayerInteractEvent event, final @NotNull InteractionClick click) {
    ...
    return click == InteractionClick.SIGN && event.getAction() == Action.LEFT_CLICK_BLOCK

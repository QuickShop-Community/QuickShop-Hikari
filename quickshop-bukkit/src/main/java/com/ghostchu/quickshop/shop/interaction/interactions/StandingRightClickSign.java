 ...
 * @since 6.2.0.11
 */
public class StandingRightClickSign implements InteractionType {
  ...
  public String identifier() {
    ...
    return "STANDING_RIGHT_CLICK_SIGN";
  }
  ...
  public boolean applies(final @NotNull PlayerInteractEvent event, final @NotNull InteractionClick click) {
    ...
    return click == InteractionClick.SIGN && event.getAction() == Action.RIGHT_CLICK_BLOCK

...
/**
 * StandingRightClickShop
 *
 * @author creatorfromhell
 * @since 6.2.0.11
 */
public class StandingRightClickShop implements InteractionType {
  ...
  public String identifier() {
    ...
    return "STANDING_RIGHT_CLICK_SHOPBLOCK";
  }
  ...
  public boolean applies(final @NotNull PlayerInteractEvent event, final @NotNull InteractionClick click) {
    ...
    return click == InteractionClick.SHOPBLOCK && event.getAction() == Action.RIGHT_CLICK_BLOCK

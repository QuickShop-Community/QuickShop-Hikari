 ...
 */
public class InventoryCommitEvent extends AbstractQSEvent implements QSCancellable {
     ...
     */
    public InventoryCommitEvent(@NotNull InventoryTransaction transaction) {

...
//                case RESERVE -> finalReport.append("Reserve").append("%").append("No details");
...
//        finalReport.append("================================================\n");
//        finalReport.append("Chat Processor:\n");
//        finalReport.append("Adventure API loaded from: ").append(Util.getClassPath(Adventure.class)).append("\n");
//        finalReport.append("Adventure Bukkit Platform loaded from: ").append(Util.getClassPath(BukkitAudiences.class)).append("\n");
//        finalReport.append("Adventure Text Serializer (Legacy) loaded from: ").append(Util.getClassPath(LegacyComponentSerializer.class)).append("\n");
//        finalReport.append("Adventure Text Serializer (Gson) loaded from: ").append(Util.getClassPath(GsonComponentSerializer.class)).append("\n");
//        finalReport.append("Adventure MiniMessage Lib loaded from: ").append(Util.getClassPath(LegacyComponentSerializer.class)).append("\n");
//        finalReport.append("================================================\n");

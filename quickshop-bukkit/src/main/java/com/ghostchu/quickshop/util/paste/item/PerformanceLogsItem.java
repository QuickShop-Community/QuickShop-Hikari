...
public class PerformanceLogsItem implements SubPasteItem {
    ...
    private String buildContent() {
        ...
        List<String> debugLogs = Log.fetchLogs(Log.Type.PERFORMANCE).stream().map(recordEntry -> "[" + format.format(recordEntry.getTimestamp()) + "] " + recordEntry.syncBuildString()).toList();
